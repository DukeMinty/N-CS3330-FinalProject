...
public class ShoppingKoreanTest {
	...
	private ShoppingKorean testShopping = null;
	...
	void setUp() throws Exception {
		testShopping = new ShoppingKorean();
	...
	void testShoppingMenu1() {
		...
		Item item = new Item("009","Tteokbokki",4.25,70,Region.KOREAN);
		testList.add(item);
		boolean testMenu = testShopping.ShopKorean(testScanner, testList, testShopperModel, testShopperController);
		assertTrue(testMenu);
	}
	@Test
	@SuppressWarnings("static-access")
	void testShoppingMenu2() {
		...
		Item item2 = new Item("009","Tteokbokki",4.25,70,Region.KOREAN);
		testList2.add(item2);
		boolean testMenu = testShopping.ShopKorean(testScanner, testList2, testShopperModel, testShopperController);
		assertTrue(testMenu);
	}
	@Test
	@SuppressWarnings("static-access")
	void testShoppingMenu3() {
		...
		testList3.add(item3);
		boolean testMenu = testShopping.ShopKorean(testScanner, testList3, testShopperModel, testShopperController);
		assertTrue(testMenu);
	}
	...
	void testShoppingMenuP() {
		...
		Item itemP = new Item("009","Tteokbokki",4.25,70,Region.KOREAN);
		testListP.add(itemP);
		boolean testMenu = testShopping.ShopKorean(testScanner, testListP, testShopperModel, testShopperController);
		assertTrue(testMenu);
	}
}
